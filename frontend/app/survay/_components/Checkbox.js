...
const Checkbox = ({ value, checked, onChange }) => {
  return (
    <div className="relative" onClick={() => onChange(value)}>
      <label className="relative flex size-8 items-center justify-center overflow-hidden rounded-full bg-gradient-to-tr from-[#5b3945] via-[#c43c26] to-[#ce848a] p-2 duration-100 hover:p-2.5">
